...
I'm an AI Engineering Leader and Senior Data Scientist with over 10 years of experience building AI solutions across finance and tech. I specialize in tackling complex problems with machine learning, from generative AI applications to large-scale fraud detection systems.
...
Leading a centralized AI team building internal tools for tax systems, finance automation, and recruitment. Focused on delivering AI solutions that improve operational efficiency across the organization.

### AI Engineer @ Google Cloud (Nov 2022 - Jun 2025)
- Built PointNet-based auto-quoting system for manufacturers to generate instant quotes for custom parts
- Developed document processing pipeline using Document AI and LLMs to automate document workflows
- Created production Dialogflow chatbot for customer service automation

### Lead Data Scientist @ Citibanamex (Jul 2020 - Nov 2022)
Led team of 6 data scientists building ML models for financial crime detection. Identified and shut down network of 100 accounts involved in human trafficking through advanced pattern recognition and investigation.

### Senior Data Scientist @ HSBC (Jan 2019 - Jul 2020)
Built risk assessment models for financial crime detection across entire customer base. Delivered solutions meeting regulatory compliance requirements for AML operations.

### Data Scientist @ Citibanamex (Sep 2016 - Jan 2019)
Optimized transaction monitoring systems, reducing false positive alerts by 40% and improving investigation efficiency.

## Education & Certifications

### Google Cloud Certified (4x)
...
My educational background combines mathematical theory, technical engineering skills, and business acumen to build AI systems that solve real problems.

## Publications

- **["Convert2PDF: An API to Transform Microsoft Office Files into PDF"](https://medium.com/google-cloud/convert2pdf-an-api-to-transform-microsoft-office-files-into-pdf-3c95ada29d67)** (2024) - Featured on Google Cloud Community Medium
- **"Detección de fraude interno utilizando metodologías de aprendizaje máquina"** (2020) - Thesis on machine learning for fraud detection
...
![](https://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=ulises-jimenez07&theme=radical)
![](https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=ulises-jimenez07&theme=radical)